    ...
    isMapVisible && (
      <div className="absolute z-10 flex items-center justify-center w-screen h-screen bg-black/70">
        <div className="block">
          ...
          <div className="flex">
            <button className="w-full p-2 my-8 text-2xl font-semibold tracking-wider bg-blue-500 rounded-full maxtext-white hover:bg-blue-700 w-[400px] sm:w-full mx-auto text-white" onClick={handleMapAppear}>
              SEARCH
            </button>
          </div>
        </div>
