...
const InfoPopup = () => {
  ...
  return alertInformation !== "" ? (
    <div className="absolute z-10 flex items-center justify-center w-screen h-screen bg-black/70">
      <div className="bg-white min-h-[400px] rounded-3xl max-w-[400px]">
        <div className="flex justify-center py-8">
          <VscError fill="red" size={100} />
        </div>
        <div className="pb-8 mx-4 max-w-[500px] block ">
          <h1 className="flex justify-center py-2 text-4xl font-bold tracking-widest">ERROR</h1>
          <h1 className="text-lg text-center text-pretty mx-auto h-[80px]">{alertInformation}</h1>
        </div>
        <div className="mb-8">
